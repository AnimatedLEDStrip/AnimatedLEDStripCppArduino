...
public:
    ...
    void
            setPixelColor(int pixel,
                          ColorContainer colorValues),    // Sets the color of one pixel to the color stored in a ColorContainer object
            ...
            setStripColor(
            ColorContainer colorValues),    // Sets the color of the whole strip to the color stored in a ColorContainer object
            setStripColor(int rIn, int gIn, int bIn);    // Overload for setStripColor()

    template<class paletteType>
    void fillLEDsFromPalette(const paletteType &palette, uint8_t startIndex, TBlendType blend,
                             uint8_t brightness); // Fills a LED strip with the colors from a FastLED Color Palette -- based on FastLED example code

    void
            fillLEDsFromPalette(const TProgmemRGBPalette16 &palette, uint8_t startIndex, TBlendType blend,
                                uint8_t brightness),    // Works with TProgmemRGBPalette32, TProgmemHSVPalette16 and TProgmemHSVPalette32 too
            fillLEDsFromPalette(const CRGBPalette16 &palette, uint8_t startIndex, TBlendType blend = LINEARBLEND,
                                uint8_t brightness = 255),
            fillLEDsFromPalette(const CRGBPalette32 &palette, uint8_t startIndex, TBlendType blend = LINEARBLEND,
                                uint8_t brightness = 255),
            fillLEDsFromPalette(const CRGBPalette256 &palette, uint8_t startIndex, TBlendType blend = LINEARBLEND,
                                uint8_t brightness = 255),
            fillLEDsFromPalette(const CHSVPalette16 &palette, uint8_t startIndex, TBlendType blend = LINEARBLEND,
                                uint8_t brightness = 255),
            fillLEDsFromPalette(const CHSVPalette32 &palette, uint8_t startIndex, TBlendType blend = LINEARBLEND,
                                uint8_t brightness = 255),
            fillLEDsFromPalette(const CHSVPalette256 &palette, uint8_t startIndex, TBlendType blend = LINEARBLEND,
                                uint8_t brightness = 255),
