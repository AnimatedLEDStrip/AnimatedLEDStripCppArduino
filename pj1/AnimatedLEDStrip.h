...
public:
	...
	void
	  ...
	  alternate(ColorContainer colorValues1, ColorContainer colorValues2, int delay),	// Runs a single alternate animation (alternates between two colors at the specified rate (amount of time between change))
